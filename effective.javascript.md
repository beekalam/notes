...
================================================================================
/home/moh/Downloads/(Effective Software Development Series) David Herman-Effective JavaScript_ 68 Specific Ways to Harness the Power of JavaScript-Addison-Wesley Professional (2012).pdf
================================================================================
...
Item 2:   
Understand JavaScript’s Floating-Point 
Numbers
================================================================================
...
behavior  of  the  
typeof
  operator,  which  classifies  integers  and  float-
...
null
  will  not  fail  in  an  arithmetic  calculation,  but  silently  convert  
to  0;  an  
undefined
  variable  will  convert  to  the  special  floating-point  
value 
NaN
  (the  paradoxically  named  “not  a  number”  number—blame  
...
particularly  difficult  even  to  test  for  the  
NaN
  value,  for  two  reasons.  
First,  JavaScript  follows  the  IEEE  floating-point  standard’s  head-  
scratching  requirement  that  
NaN
  be  treated  as  unequal  to  itself.  So  
testing whether a value is equal to 
NaN
 doesn’t work at all:
var
 x = NaN;
...
isNaN
  library  function  is  not  very  reliable  
because it comes with its own implicit coercion, converting its argu-
ment to a number before testing the value. (A more accurate name for 
isNaN
...
coercesToNaN
.)  If  you  already  know  
that a value is a number, you can test it for 
NaN
 with 
isNaN
:
isNaN(NaN);
// true
But  other  values  that  are  definitely  not  
NaN
,  yet  are  nevertheless  
coercible to 
NaN
...
what unintuitive—for testing for 
NaN
. Since 
NaN
 is the only JavaScript 
